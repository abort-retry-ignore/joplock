...
const themeOptions = [['aritim-dark','Aritim Dark'],['dark','Dark'],['matrix-amber','Dark Amber'],['matrix-blue','Dark Blue'],['dark-fruit','Dark Fruit'],['dark-grey','Dark Grey'],['matrix-orange','Dark Orange'],['matrix-purple','Dark Purple'],['dark-red','Dark Red'],['dracula','Dracula'],['earth','Earth'],['fireball','Fireball'],['fruit','Fruit'],['grey','Grey'],['light','Light'],['matrix','Matrix'],['nord','Nord'],['oled-dark','OLED Dark'],['solarized-dark','Solarized Dark'],['solarized-light','Solarized Light'],['swamp-thing','Swamp Thing']];
