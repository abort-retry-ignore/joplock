...
test('double-click opens image/attachment in the in-app lightbox (desktop)', () => {
	...
	assert.ok(appJs.includes("var resViewer=document.getElementById('resource-viewer');if(resViewer&&!resViewer.hidden){_log('esc:resource-viewer visible, closing');_closeResourceViewer();return}"));
